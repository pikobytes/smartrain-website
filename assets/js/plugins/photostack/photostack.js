...
;( function( window ) {
    ...
    function Photostack( el, options ) {
        ...
        this.items = [].slice.call( this.inner.querySelectorAll( 'div.portfolio-block:not([data-dummy])' ) );
        this.itemsCount = this.items.length;
        gfortItemsCount = this.items.length - 1;
    ...
    Photostack.prototype._addNavigation = function() {
        ...
        this.wrapper.className = "gfort-photostack-nav-wrapper";
        this.prevArrow = document.createElement( 'span' );
        this.prevArrow.className = "gfort-photostack-prev";
        this.nextArrow = document.createElement( 'span' );
        this.nextArrow.className = "gfort-photostack-next";
        ...
        this.wrapper.appendChild(this.prevArrow);
        this.wrapper.appendChild(this.nav);
        this.wrapper.appendChild(this.nextArrow);
        this.el.appendChild( this.wrapper );
        this.navDots = [].slice.call( this.nav.children );
        this.navperv = [].slice.call( this.prevArrow );
        this.navnext = [].slice.call( this.nextArrow );
    }
    ...
    Photostack.prototype._initEvents = function() {
        ...
        jQuery(this.nextArrow).on('click', function () {
            var gfortidx = self.current;
            if( gfortidx === gfortItemsCount ) {
                gfortidx = 0;
                var callback = function() { self._showPhoto( gfortidx ); }
            } else {
                gfortidx = gfortidx + 1;
                var callback = function() { self._showPhoto( gfortidx ); }
            }
        ...
        jQuery(this.prevArrow).on('click', function () {
