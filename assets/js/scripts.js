...
recaptchaSiteKey = 'AIzaSyDOoomls7cd-PImbTIXW26rII3n9fDn1s4';
...
googleMapAPIKey = 'AIzaSyDOoomls7cd-PImbTIXW26rII3n9fDn1s4';
...
jQuery(document).ready(function () {
    ...
    /* =========================================================================
    Language Button class toggle
    ========================================================================= */
    jQuery('.language-trigger').on('click',function() {
        jQuery('ul.language-nav').toggleClass('active');
    });
...
jQuery(window).load(function () {
  ...
  if (jQuery('.lazyload').length) {
    jQuery('.lazyload').each(function(index, el) {
        var imgPath = el.getAttribute('data-bg');
